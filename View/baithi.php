...
?>
            <table class="mt-md-4">
                ...
                <tr>
                    <td style="height: 40px; width:40px" class="text-md-end"><h6 ><input type="radio"   value="<?php echo $set['dapanA']; ?>" name="chon[<?php echo $set['maND']; ?>]" <?php if (isset($_SESSION["checkeds"][$set['maND']], $set['dapanA']) && $_SESSION['checkeds'][$set['maND']] == $set['dapanA']) {echo 'checked="checked"';}?>  id="" ></h6> </td>
                    <td ><h6  class="ms-md-2 " style="margin-bottom:15px"><b><?php echo $set['dapanA']; ?></b></h6> </td>
                </tr>
                <tr>
                    <td style="height: 40px; width:40px" class="text-md-end"><h6 ><input type="radio"  value="<?php echo $set['dapanB']; ?>" name="chon[<?php echo $set['maND']; ?>]" <?php if (isset($_SESSION["checkeds"][$set['maND']]) && $_SESSION['checkeds'][$set['maND']] == $set['dapanB']) {echo 'checked="checked"';}?> id=""></h6> </td>
                    <td ><h6  class="ms-md-2 " style="margin-bottom:15px"><b> <?php echo $set['dapanB']; ?></b></h6> </td>
                </tr>
                <tr>
                    <td style="height: 40px; width:40px" class="text-md-end"><h6 ><input type="radio"  value="<?php echo $set['dapanC']; ?>" name="chon[<?php echo $set['maND']; ?>]" <?php if (isset($_SESSION["checkeds"][$set['maND']]) && $_SESSION['checkeds'][$set['maND']] == $set['dapanC']) {echo 'checked="checked"';}?>  id=""></h6> </td>
                    <td ><h6  class="ms-md-2 " style="margin-bottom:15px"><b> <?php echo $set['dapanC']; ?></b></h6> </td>
                </tr>
                <tr>
                    <td style="height: 40px; width:40px" class="text-md-end"><h6 ><input type="radio"  value="<?php echo $set['dapanD']; ?>" name="chon[<?php echo $set['maND']; ?>]" <?php if (isset($_SESSION["checkeds"][$set['maND']]) && $_SESSION['checkeds'][$set['maND']] == $set['dapanD']) {echo 'checked="checked"';}?> id=""></h6> </td>
